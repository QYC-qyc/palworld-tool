                ...
                >
                  <template #suffix>
                    <n-tooltip trigger="hover" placement="top">
                      ...
                      <span class="help-text">点击「生成 Token」自动写入 PalDefender 令牌，也可手动粘贴。请勿将 API 端口暴露到公网。</span>
                    </n-tooltip>
                  </template>
                </n-input>
...
import { api } from '@/api'
import PdMessages from '@/components/paldefender/PdMessages.vue'
