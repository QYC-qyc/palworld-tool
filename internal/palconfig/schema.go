...
func Schema() []Field {
	fields := []Field{
		...
		boolField("bIsStartLocationSelectByMap", "允许选择出生地点", "True", "新玩家可在地图上选择初始出生区域", "游戏设置", false),
		...
		boolField("bEnablePlayerToPlayerDamage", "玩家间伤害", "False", "允许玩家对其他玩家造成伤害（非PVP）", "战斗", false),
		boolField("bEnableDefenseOtherGuildPlayer", "他公会玩家防御", "False",
			"对其他公会玩家启用防御判定", "战斗", false),
		boolField("bEnableNonLoginPenalty", "离线惩罚", "True",
			"玩家长时间不登录时施加惩罚", "战斗", false),
		...
		boolField("bActiveUNKO", "启用UNKO", "False", "未知功能（官方保留）", "经济与掉落", false),
		intField("DropItemMaxNum_UNKO", "UNKO掉落物上限", "100", "UNKO 掉落物最大数量", "经济与掉落", false, 0, 0),
		...
		{Key: "BlockRespawnTime", Label: "死亡复活冷却(秒)", Type: TypeFloat, Default: "5.0",
			Description: "死亡后需要等待多久才能复活（秒）", Group: "游戏设置", Min: fmin(0)},
		{Key: "RespawnPenaltyDurationThreshold", Label: "复活惩罚阈值(秒)", Type: TypeFloat, Default: "0",
			Description: "应用复活时间倍率的连续死亡间隔阈值（秒）", Group: "游戏设置", Min: fmin(0)},
		{Key: "RespawnPenaltyTimeScale", Label: "复活惩罚时间倍率", Type: TypeFloat, Default: "2.0",
			Description: "短时间内连续死亡时复活等待时间的倍率", Group: "游戏设置", Min: fmin(0), Step: fstep(0.1)},
		...
		boolField("bAllowEnhanceStat_Health", "允许强化HP", "True", "允许玩家分配点数到生命值", "游戏设置", false),
		boolField("bAllowEnhanceStat_Attack", "允许强化攻击", "True", "允许玩家分配点数到攻击", "游戏设置", false),
		boolField("bAllowEnhanceStat_Stamina", "允许强化耐力", "True", "允许玩家分配点数到耐力", "游戏设置", false),
		boolField("bAllowEnhanceStat_Weight", "允许强化负重", "True", "允许玩家分配点数到负重", "游戏设置", false),
